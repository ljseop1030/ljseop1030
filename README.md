...
* **Typoem (Social Poetry Web Platform)** 
  ...
  * Handled routing, database schema mapping, and managed over 20 endpoints for user authentication and content sharing.
* **XV6 OS Design**
  * Developed a custom operating system based on XV6 using **C**.
  * Implemented CPU scheduling algorithms (SJF) and custom system calls while minimizing modifications to the core architecture.
* **Smart Waste Bin Backend Integration (Industry-Academic Project)**
  * Managed the backend integration for a Raspberry Pi-based smart waste bin.
  * Successfully linked AI models to the backend and resolved API communication bottlenecks.
* **Study Space Availability Tracker (MVP)**
  * Built an experimental backend using **Firebase** and Beacon simulators to track real-time seat occupancy.

---
<!-- ⚡ Fun fact: I'm the designated "troubleshooter" in my teams. If an AI generated code and it suddenly panics, I'm the one who reads the surrounding code and prints my way to the solution! -->
